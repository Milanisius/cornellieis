...
WORKINGDIR="/tmp/cornellieis"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/cornellieis/Cornellieis/cornellieis-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/cornellieis/Cornellieis/"
VERSIONPREFIX="cornellieis-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'cornellieis-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[cornellieis-]<version>-[rc[0-9]] (example: cornellieis-0.7.1-rc1)"
   echo "wget output:"
