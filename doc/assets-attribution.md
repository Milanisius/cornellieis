The following is a list of assets used in the cornellieis source and their proper attribution.
...
* License: MIT
* Site: [https://cornellieistalk.org/index.php?topic=15276.0](https://cornellieistalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original cornellieis logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/cornellieis.icns, src/qt/res/src/cornellieis.svg,
	src/qt/res/src/cornellieis.ico, src/qt/res/src/cornellieis.png,
	src/qt/res/src/cornellieis_testnet.png, docs/cornellieis_logo_doxygen.png,
