Cornellieis-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cornellieis/files/Cornellieis/cornellieis-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cornellieis
...
New/changed settings (command-line or cornellieis.conf file)
--------------------------------------------------------
