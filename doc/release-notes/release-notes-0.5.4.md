Cornellieis version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cornellieis/files/Cornellieis/cornellieis-0.5.4/
...
http://gitorious.org/cornellieis/cornellieisd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cornellieis-Qt notifications under Growl 1.3.
Increase required age of Cornellieis-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCornellieis properly when installing Cornellieis-Qt over it. (Windows)
