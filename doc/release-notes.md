Cornellieis Core version 0.9.4 is now available from:

  https://cornellieis.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/Cornellieis-Qt (on Mac) or
cornellieisd/cornellieis-qt (on Linux).
...
this update is incompatible with the Cornellieis system and could lead to consensus
forks.

Cornellieis Core released binaries from https://cornellieis.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cornellieis/+archive/ubuntu/cornellieis
- A third-party or self-compiled Cornellieis Core

upgrade to Cornellieis Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cornellieis/).
