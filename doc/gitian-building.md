...
*Setup instructions for a gitian build of Cornellieis using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Cornellieis
...
- [Building Cornellieis](#building-cornellieis)
...
Clone the git repositories for cornellieis and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/cornellieis/cornellieis
```
...
In [doc/release-process.md](release-process.md) in the cornellieis repository under 'Fetch and build inputs'.
...
Building Cornellieis
----------------

To build Cornellieis (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the cornellieis repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cornellieis/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/cornellieis/cornellieis
...
For example:
```bash
URL=https://github.com/laanwj/cornellieis.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit cornellieis=${COMMIT} --url cornellieis=${URL} ../cornellieis/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit cornellieis=${COMMIT} --url cornellieis=${URL} ../cornellieis/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/cornellieis-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cornellieis-build.assert
```
...
[cornellieis/gitian.sigs](https://github.com/cornellieis/gitian.sigs/) repository, or
