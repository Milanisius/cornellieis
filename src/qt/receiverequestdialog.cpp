...
#include "cornellieis-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCornellieisURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CornellieisUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCornellieisURI(info));
}
