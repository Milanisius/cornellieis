...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/cornellieis"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cornellieis"),
     ...
     * override -datadir in the cornellieis.conf file in the default data directory
     * (to be consistent with cornellieisd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
